...
export default function OriginNavbar({ isScrolled }: OriginNavbarProps) {
      ...
      >
        ...
        <div className="hidden md:flex items-center gap-8">
          ...
          <div className="flex items-center gap-4 ml-4 pl-4 border-l border-white/10">
            <button className="text-[11px] font-bold uppercase tracking-[0.2em] text-white/40 hover:text-white transition-colors whitespace-nowrap">
              Log in
            </button>
            <button
              onClick={() => scrollTo("#contact")}
              className={`text-[10px] font-bold uppercase tracking-[0.2em] px-5 py-2.5 rounded-full transition-all duration-500 whitespace-nowrap
                ${isScrolled
